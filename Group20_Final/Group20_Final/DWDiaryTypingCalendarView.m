...
- (UILabel *)labelDay {
    if (!_labelDay) {
        ...
        _labelDay.font = [UIFont fontWithName:@"STHeitiSC-Light" size:40];
...
- (void)transformToSmallMood {
    ...
    self.labelSmall.text = [NSString stringWithFormat:@"%@%@, hei%@", self.dicDate[@"month"], self.dicDate[@"day"], self.dicDate[@"week"]];
