...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([SettingManage sharedInstance].isLocked) {
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Group20_Final" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Group20_Final.sqlite"];
    NSError *error = nil;
...
- (void)loadUserInfoFromDataBase {
    ...
    if ([objects count] > 0) {
        ...
        [SettingManage sharedInstance].isLocked = ((NSNumber *)[theUserInfo valueForKey:@"isLocked"]).integerValue;
    } else {
        [SettingManage sharedInstance].isLocked = NO;
    }
}
