...
- (UIView *)dateView {
    if (!_dateView) {
        ...
        _dateView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bgd"]];
...
- (UITextView *)tVDetail {
    if (!_tVDetail) {
        ...
        _tVDetail.textColor = ThemeFontColor;
...
- (UIView *)toolBar {
    if (!_toolBar) {
        ...
        _toolBar.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"bgd"]];
...
- (DWDiaryAlertView *)alertView {
    if (!_alertView) {
        ...
        _alertView.title = @"Delete diary";
        _alertView.message = @"Are you sure you want to delete this journal?";
